...
const file_api_multicast_group_proto_rawDesc = "" +
	"\n" +
	"\x19api/multicast_group.proto\x12\x03api\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x13common/common.proto\"\x9e\x04\n" +
	...
	"\tfrequency\x18\v \x01(\rR\tfrequency\x126\n" +
	"\x18class_b_ping_slot_period\x18\f \x01(\rR\x14classBPingSlotPeriod\x121\n" +
	"\x16class_b_ping_slot_nb_k\x18\x0e \x01(\rR\x11classBPingSlotNbK\x12X\n" +
