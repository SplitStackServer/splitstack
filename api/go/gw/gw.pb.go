...
const file_gw_gw_proto_rawDesc = "" +
	"\n" +
	"\vgw/gw.proto\x12\x02gw\x1a\x13common/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xa8\x01\n" +
	"\n" +
	"Modulation\x12,\n" +
	...
	"\x0estats_interval\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rstatsInterval\"\xe3\x02\n" +
	...
	"\n" +
	"\x06ONLINE\x10\x01\"\xb4\x01\n" +
	"\rMeshHeartbeat\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"relay_path\x18\x04 \x03(\v2\x1a.gw.MeshHeartbeatRelayPathR\trelayPath\"Y\n" +
	"\x16MeshHeartbeatRelayPath\x12\x19\n" +
	"\brelay_id\x18\x01 \x01(\tR\arelayId\x12\x12\n" +
	"\x04rssi\x18\x02 \x01(\x05R\x04rssi\x12\x10\n" +
	"\x03snr\x18\x03 \x01(\x05R\x03snr*\xb5\x01\n" +
	"\bCodeRate\x12\x10\n" +
